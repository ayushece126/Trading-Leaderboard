        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <Button
              ...
              variant="outline"
              className="bg-[#1A1B20] border-[#2A2D3A] text-white hover:bg-[#2A2D3A] transition-colors duration-300"
            >
          ...
          <TabsList className="bg-[#111217] p-1 rounded-full inline-flex">
            {["Daily", "Weekly", "Monthly"].map((period) => (
              <TabsTrigger
                ...
                className="px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 data-[state=active]:bg-[#2A2D3A] data-[state=active]:text-white"
              >
                {period}
              </TabsTrigger>
            ))}
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-xl font-bold mr-4">
                      {trader.name[0]}
                    </div>
                    <div>
                ...
                <div className="flex justify-between items-center mb-6">
                  <div className="text-3xl font-bold text-green-400">{trader.pnl} ≋</div>
                  <div className="text-sm text-gray-400">{trader.value}</div>
                </div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-green-400">{trader.greenTrades} Wins</span>
                  <span className="text-red-400">{trader.redTrades} Losses</span>
                </div>
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="w-32">
                    ...
                    <div className="flex justify-between text-xs mt-1">
                      <span className="text-green-400">{trader.greenTrades}W</span>
                      <span className="text-red-400">{trader.redTrades}L</span>
                    </div>
                  </div>
                </div>
              </div>
